...
Cnvrtsfx allows you to convert existing PSG sound effects into a format suitable for use with MBMSFXPlay.
Naturally, the result will not be the same, but it will be a fair approximation. 
I suggest raising the volume of the original SFX to maximum, otherwise the FM version will be too quiet.
...
- Use sverx's vgm2psg to convert the vgm file to a psg file.
  (You can get vgm2psg from https://github.com/sverx/PSGlib/tree/master/tools)
