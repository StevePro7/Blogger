...
Object.defineProperty(e,"__esModule",{value:!0})
e.default=void 0
const{setDestroyed:u,setDestroying:c}=a,l=(0,i.capabilities)("3.13",{destructor:!0,asyncLifecycleCallbacks:!1,updateHook:!1}),f=t.default.destroy,d=t.default._registerDestructor
class m extends((0,s.default)(n.setOwner,n.getOwner,l)){createComponent(e,t){const r=super.createComponent(e,t)
d(r,(()=>{r.willDestroy()}))
return r}destroyComponent(e){f(e)}}0
var b=m
e.default=b}))
